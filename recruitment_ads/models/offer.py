...
class Offer(models.Model):
    ...
    def _offer_name(self):
        offer_name = "Create Offer / " + self.application_id.job_id.name + " / " + self.application_id.partner_id.name
    ...
    def _compute_total_package(self):
        total_package = self.fixed_salary + self.variable_salary + self.housing_allowance + self.travel_allowance + self.mobile_allowance
