...
class HRSetMonthlyTargetLine(models.Model):
    ...
    offer_weight = fields.Integer( track_visibility='always',string='Offer Weight',readonly=True)
    hire_weight = fields.Integer(track_visibility='always', string='Hire Weight',readonly=True)
