...
class HRSetMonthlyTargetLine(models.Model):
    ...
    expecting_offer_date = fields.Date(track_visibility='always', string='Expecting Offer Date', readonly=True,
                                       compute='compute_offer_hire_expecting_date')
    expecting_hire_date = fields.Date(track_visibility='always', string='Expecting Hire Date', readonly=True,
                                      compute='compute_offer_hire_expecting_date')
