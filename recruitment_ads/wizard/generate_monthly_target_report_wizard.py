...
class GenerateMonthlyTargetReportWizard(models.TransientModel):
    _name = "generate.monthly.target.report.wizard"
    ...
    def default_get(self, fields):
        res = super(GenerateMonthlyTargetReportWizard, self).default_get(fields)
    ...
    @api.multi
    def button_generate_monthly_report(self):
        self.ensure_one()
        if self.job_ids:
        ...
        report = self.env.ref('recruitment_ads.action_report_generate_monthly_target_xlsx')
